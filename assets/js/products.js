...
(function () {
  ...
  const seed = (n) => `https://picsum.photos/seed/volt${n}/640/480`;
  ...
  const PRODUCTS = [
    ...
    { id: 13, name: "SprintFit Sport Buds", cat: "Headphones", sub: "Sports", brand: "JBL", price: 129, was: 159, rating: 4.3, badge: "sale", img: seed(113) },
    { id: 14, name: "AirWave Buds 2", cat: "Headphones", sub: "Wireless", brand: "Apple", price: 199, was: null, rating: 4.6, badge: "new", img: seed(114) },
    { id: 15, name: "PulseWatch Fit Pro", cat: "Smartwatches", sub: "Fitness", brand: "Samsung", price: 279, was: null, rating: 4.5, badge: "", img: seed(115) },
